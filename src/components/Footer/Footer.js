...
export default function Footer() {
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2023 Llogical —
      <a href="https://firebasestorage.googleapis.com/v0/b/sansaptak-b8665.appspot.com/o/vector%20images%2FFB_IMG_1674130454403.jpg?alt=media&token=ce95125b-e8ee-4508-b1ab-f21d41352c67" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">support@llogical.com</a>
    </p>
