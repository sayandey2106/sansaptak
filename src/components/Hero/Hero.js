...
{/* hero start */}
  ...
  <div class=" mx-auto flex px-5 py-14 md:flex-row flex-col items-center">
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img class="object-cover object-center rounded" alt="hero" height="200px" src="https://firebasestorage.googleapis.com/v0/b/sansaptak-b8665.appspot.com/o/vector%20images%2FStudents%20watching%20webinar%20on%20computer.jpg?alt=media&token=2cd34a54-a18e-4444-8558-b35d923bf540"/>
    </div>
  </div>
</section>
</Container>
